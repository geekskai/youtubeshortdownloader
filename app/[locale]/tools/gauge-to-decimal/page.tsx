  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-7xl space-y-5 px-3 py-5 sm:px-4 sm:py-6 md:space-y-7 md:px-6 md:py-8 lg:space-y-8 lg:px-8 lg:py-10">
        <header className="rounded-3xl border border-cyan-500/25 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-purple-500/10 p-4 text-center shadow-xl sm:p-5 md:p-6 lg:p-8">
