    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="mx-auto max-w-7xl space-y-5 px-3 py-5 sm:px-4 sm:py-6 md:space-y-7 md:px-6 md:py-8 lg:space-y-8 lg:px-8 lg:py-10">
        <header className="space-y-3.5 text-center sm:space-y-4 md:space-y-5">
          ...
          <h1 className="mx-auto max-w-5xl bg-gradient-to-r from-cyan-200 via-blue-100 to-purple-200 bg-clip-text text-2xl font-bold leading-tight text-transparent sm:text-3xl md:text-5xl">
            {t("h1")}
          </h1>
          <p className="mx-auto max-w-7xl text-sm leading-6 text-slate-300 sm:leading-7 md:text-lg">
            {t("intro")}
          </p>
        </header>
